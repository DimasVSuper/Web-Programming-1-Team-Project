<?php
// Menampilkan URI Request untuk keperluan debugging
echo "Request URI: " . $_SERVER['REQUEST_URI'];
?>

<!-- Header Navigasi - Berisi menu navigasi utama dan branding -->
<header class="navbar navbar-expand-lg navbar-dark bg-primary sticky-top shadow-lg" style="background: linear-gradient(90deg, #007bff 0%, #00c6ff 100%);">
  <div class="container">
    <!-- Logo dan Nama Brand - Identitas utama situs -->
    ...
    <!-- Tombol Toggle Navigasi Mobile - Muncul pada layar kecil -->
...
<!-- Bagian Hero - Menampilkan judul utama dan gambar hero -->
...
<!-- Bagian Layanan Utama - Menjelaskan layanan reparasi -->
...
<!-- Bagian Carousel - Menampilkan slideshow gambar layanan -->
...
<!-- Bagian Layanan Detail - Menampilkan jenis layanan dengan ikon -->
...
<!-- Bagian Lokasi - Menampilkan peta dan informasi lokasi -->
