...
<section id="contact-section" class="full-section mb-4">
    <div class="container">
        ...
        <!-- Hero Section Start -->
        <!-- Bagian hero dengan gambar latar dan teks overlay -->
        <div class="hero-contact mb-5" style="position:relative;overflow:hidden;border-radius:18px;">
            ...
            <!-- Konten overlay di atas gambar hero -->
...
<!-- Script untuk menangani notifikasi -->
<script>
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Menampilkan notifikasi jika ada status
    if(status) {
        ...
        // Otomatis sembunyikan notifikasi setelah 4 detik
        setTimeout(function(){
            notif.style.display = 'none';
        }, 4000);
        
        // Handler untuk tombol tutup notifikasi
